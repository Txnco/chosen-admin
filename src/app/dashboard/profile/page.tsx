...
export default function ProfilePage() {
  ...
  const handleSuspendAccount = () => {
    // TODO: Implement account suspension functionality
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {isCurrentUser ? 'Manage your account settings' : `Profile for ${profileUser.first_name} ${profileUser.last_name}`}
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <div className="w-full pt-4 border-t border-gray-100 space-y-3">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">{format(new Date(profileUser.created_at), 'MMM yyyy')}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{format(new Date(profileUser.created_at), 'MMM dd, yyyy HH:mm')}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{format(new Date(profileUser.updated_at), 'MMM dd, yyyy HH:mm')}</p>
                        </div>
                      </div>
                    </div>
                  </div>
